...
public class App {
    public static void main(String[] args) {
        ...
        */
        ...
        int n1 = Integer.parseInt(JOptionPane.showInputDialog("Digite número 1.."));
        double n2 = Double.parseDouble(JOptionPane.showInputDialog("Digite número 2.."));
        JOptionPane.showMessageDialog(null, "Resultado de: " + n1+ " + "+ n2 + "   Es igual a: " + (n1+n2) );
